package com.pos.point_of_sales.controller.sales;
...
import com.pos.point_of_sales.interfaces.SaleInterface;
...
public class SalesController implements Initializable, SaleInterface {
    ...
    /**
     * Handles the action when the Deleete button is clicked.
     *
    ...
    public void deleteAction(ActionEvent event) throws SQLException {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            if (selectedSale != null) {
                ...
                LOG.warn("No sale selected for deletion.");
            }
        }
